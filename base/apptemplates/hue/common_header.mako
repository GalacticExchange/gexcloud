...
<div class="navigator">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a title="${_('Manage HDFS')}" rel="navigator-tooltip" href="/${apps['filebrowser'].display_name}"><i class="fa fa-file"></i><span >&nbsp;${_('File Browser')}&nbsp;</span></a></li>
    % endif
    % if 'jobbrowser' in apps:
    <li><a title="${_('Manage jobs')}" rel="navigator-tooltip" href="/${apps['jobbrowser'].display_name}"><i class="fa fa-list-alt"></i><span >&nbsp;${_('Job Browser')}&nbsp;</span><span id="jobBrowserCount" class="badge badge-warning hide" style="padding-top:0;padding-bottom: 0"></span></a></li>
    % endif
##    <li class="dropdown">
...
##    % endif
##<% SK    <li id="jHueTourFlagPlaceholder"></li>
